...
it('builds a filter transform via the static convenience', function (): void {
...
it('builds a sort transform via the static convenience', function (): void {
...
it('builds a sort transform with a list of order expressions', function (): void {
    expect(
        Transform::sort([
...
it('builds a generic transform via type() and config()', function (): void {
...
it('emits print for debugging', function (): void {
...
it('lets raw() override any typed key on transform', function (): void {
