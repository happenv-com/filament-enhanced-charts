...
it('builds dim and name', function (): void {
...
it('defaults inverse() to true', function (): void {
...
it('builds nameLocation', function (): void {
...
it('defaults scale() to true', function (): void {
