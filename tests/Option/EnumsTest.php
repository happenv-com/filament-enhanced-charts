...
it('accepts a TooltipTrigger enum or a raw string on Tooltip::trigger', function (): void {
...
it('accepts an Orient enum or a raw string on VisualMap::orient', function (): void {
...
it('accepts a Sort enum or a raw string on FunnelSeries::sort', function (): void {
...
it('accepts a NodeAlign enum or a raw string on SankeySeries::nodeAlign', function (): void {
...
it('accepts a RoseType enum or a raw string on PieSeries::roseType', function (): void {
...
it('accepts a LineType enum or a raw string on LineStyle::type', function (): void {
...
it('keeps the dashed/dotted/solid helpers working after widening LineStyle::type', function (): void {
...
it('accepts a Focus enum or a raw string on Emphasis::focus', function (): void {
