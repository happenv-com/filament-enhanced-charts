...
it('deep-merges associative arrays, override wins', function () use ($make): void {
    $o = $make()->raw(['grid' => ['top' => 10], 'legend' => ['show' => false]]);
    expect($o->out(['grid' => ['left' => 8, 'top' => 4]]))
        ->toBe(['grid' => ['left' => 8, 'top' => 10], 'legend' => ['show' => false]]);
});

it('replaces lists wholesale rather than merging by index', function () use ($make): void {
