...
- **[Gauge](#gauge)** — [Speedometer (animated)](#speedometer-animated), [Progress rings](#progress-rings)
...
| Light | Dark |
|:---:|:---:|
| <img src="screens/gauge-light.gif" alt="Gauge: Speedometer (animated), light mode" width="100%"> | <img src="screens/gauge-dark.gif" alt="Gauge: Speedometer (animated), dark mode" width="100%"> |
    ...
    protected function getOption(): Option
    {
        return Option::make()->series(
            GaugeSeries::make()
                ...
                ->axisTick(['distance' => -14, 'length' => 6, 'lineStyle' => ['width' => 1]])
                ->splitLine(['distance' => -14, 'length' => 14, 'lineStyle' => ['width' => 3]])
